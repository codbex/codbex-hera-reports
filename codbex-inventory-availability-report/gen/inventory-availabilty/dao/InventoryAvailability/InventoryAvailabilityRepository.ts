...
export class InventoryAvailabilityRepository {
    ...
    public findAll(filter: InventoryAvailabilityPaginatedFilter): InventoryAvailability[] {
        const sql = `
            SELECT Product.PRODUCT_ID as "Product ID", Product.PRODUCT_BATCH as "Product Number", Product.PRODUCT_NAME as "Product Name", Catalogue.CATALOGUE_QUANTITY as "Quantity Available", Store.STORE_NAME as "Store "
